...
class ProgressBar(QGridLayout):
    def __init__(self):
        ...
        self.step4_button = QPushButton("4  Features selection")
        self.step4_button.setEnabled(False)
        self.step5_button = QPushButton("5  PCA")
        ...
        self.step6_button.setStyleSheet(self.btn_done)
        self.step7_button.setStyleSheet(self.btn_done)
        ...
        self.addWidget(self.step6_button, 0, 5)
        self.addWidget(self.step7_button, 0, 6)
        ...
        self.step6_button.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        self.step7_button.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        ...
        self.step6_button.setMinimumHeight(40)
        self.step7_button.setMinimumHeight(40)
        ...
        self.step6_button.setMaximumHeight(60)
        self.step7_button.setMaximumHeight(60)
